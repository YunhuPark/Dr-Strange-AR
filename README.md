...
| `[2]` | **Sling Ring** | 🤙 양손 총 모양 (엄지·검지·중지 뻗기, 약지·새끼 접기) → 원 그리기 → 자세 유지 | GPU 파티클 슬링 링 포탈 이펙트 |
| `[3]` | **Time Stone** | 🖐️ 한 손 손바닥 펼치기 | 타임 스톤 이펙트 |

### 슬링 링 사용법
1. 양손을 총 모양으로 만들기 (엄지·검지·중지 뻗고, 약지·새끼는 접기)
2. 오른손 검지로 허공에 원 그리기
...
- 총 모양(Gun Shape) 인식: 엄지·검지·중지 뻗음 + 약지/새끼 접힘 체크
